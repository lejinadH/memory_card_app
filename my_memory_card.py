...
questions_list = []
questions_list.append(Question('The state language of Brazil', 'Portuguese', 'English', 'Spanish', 'Brazilian')) #dodajemo pitanje 1
questions_list.append(Question('Which color does not appear on the American flag?', 'Green', 'Red', 'White', 'Blue')) #dodajemo pitanje 2
questions_list.append(Question('A traditional residence of the Yakut people', 'Urasa', 'Yurt', 'Igloo', 'Hut')) #dodajemo pitanje 3
...
def check_answer():
    ...
    if answers[0].isChecked(): 
        ...
        if answers[1].isChecked() or answers[2].isChecked() or answers[3].isChecked():
            ...
            print('Rating: ', (window.score/window.total*100), '%') #printamo rejting/procentualni broj tačnih odgovora
